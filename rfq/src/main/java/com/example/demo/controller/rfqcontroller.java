...
public class rfqcontroller {
	...
	public ResponseEntity<List<SupplierVo>> getvendors(@RequestHeader("Authorization") String authorization,@PathVariable int rfqId){
	...
	public ResponseEntity<List<rfq>> getRFQ(@RequestHeader("Authorization") String authorization){
		afeign.getUname(authorization);
